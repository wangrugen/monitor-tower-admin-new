...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar-2">
        ...
        <div class="wu-toolbar-search">
            ...
            <label>用户名：<input id="username" class="easyui-textbox" style="width:100px"></label>
            <label>手机号：<input id="mobile"class="easyui-textbox" style="width:100px"></label>
            <label>Email：<input  if="email"class="easyui-textbox" style="width:100px"></label>
	...
	*/
	$('#wu-datagrid-2').datagrid({
		...
		columns:[[
			...
			{ field:'username',title:'用户名',width:180,sortable:true},
			{ field:'mobile',title:'手机号',width:100},
			{ field:'email',title:'邮箱',width:100},
			{ field:'insert_time',title:'注册时间',width:100},
			{ field:'update_time',title:'更新时间',width:100},
			{ field:'is_del',title:'是否删除',width:100},
            { field:'is_job',title:'是否在职',width:100}
		]]
	});
</script>