...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="./index.html">中北大学测试</a></div>
        <div class="left_open">
            <i title="展开左侧栏" class="iconfont">&#xe699;</i>
        </div>
        <ul class="layui-nav left fast-add" lay-filter="">
          <li class="layui-nav-item">
            <a href="javascript:;">门户</a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              <dd><a onclick="x_admin_show('中北主页','http://www.baidu.com')"><i class="iconfont">&#xe6a2;</i>中北主页</a></dd>
              <!--<dd><a onclick="x_admin_show('','http://www.baidu.com')"><i class="iconfont">&#xe6a8;</i>图片</a></dd>-->
    ...
    <div class="page-content">
        <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
          <ul class="layui-tab-title">
            <li class="home"><i class="layui-icon">&#xe68e;</i>中北大学测试项目主页</li>
          </ul>
          <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='temp/welcome.jsp' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
          </div>
        </div>
    </div>
    ...
    <!-- 底部开始 -->
    <div class="footer">
        <div class="copyright">Copyright ©2019 WangRugen All Rights Reserved </div>
    </div>
    <!-- 底部结束 -->
