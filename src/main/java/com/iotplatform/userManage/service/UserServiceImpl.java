package com.iotplatform.userManage.service;



import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.iotplatform.shiro.ShiroRealm;
import com.iotplatform.userManage.dao.RoleMapper;
import com.iotplatform.userManage.dao.UserMapper;
import com.iotplatform.userManage.dao.UserRoleMapper;
import com.iotplatform.userManage.entity.UserDTO;
import com.iotplatform.userManage.entity.UserRoleDTO;
import com.iotplatform.userManage.entity.UserRolesVO;
import com.iotplatform.userManage.entity.UserSearchDTO;
...
import com.iotplatform.utils.PageDataResult;
	...
	public PageDataResult getUsers(UserSearchDTO userSearch, int page, int limit) {
		...
		if (null != userSearch) {
			if (StringUtils.isNotEmpty(userSearch.getInsertTimeStart())
				...
				userSearch.setInsertTimeEnd(DateFormatUtils.format(new Date(),"yyyyMMddHHssmm"));
			} else if (StringUtils.isEmpty(userSearch.getInsertTimeStart())
					&& StringUtils.isNotEmpty(userSearch.getInsertTimeEnd())) {
				userSearch.setInsertTimeStart(DateFormatUtils.format(new Date(),"yyyyMMddHHssmm"));
			}
			if (StringUtils.isNotEmpty(userSearch.getInsertTimeStart())
					&& StringUtils.isNotEmpty(userSearch.getInsertTimeEnd())) {
