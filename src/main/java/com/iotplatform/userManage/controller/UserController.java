package com.iotplatform.userManage.controller;
...
public class UserController {
	...
	public PageDataResult getUsers(@RequestParam("page") Integer page,
								   @RequestParam("rows") Integer limit, UserSearchDTO userSearch) {
	...
	public static void main(String[] args) throws ParseException {
		Date date = DateUtils.parseDate("2018-01-04 20:15:21");
		Date date1 = DateUtils.parseDate("2018-01-04 20:11:21");
		Date date2 = DateUtils.parseDate("2018-01-04 20:12:21");
